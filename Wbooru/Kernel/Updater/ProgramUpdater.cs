    ...
    public static class ProgramUpdater
    {
        ...
        public static bool CheckUpdatable()
        {
            ...
            try
            {
                ...
                CacheUpdatableReleaseInfo = (option.UpdatableTargetVersion == GlobalSetting.UpdatableTarget.Preview ? updatable_releases.FirstOrDefault() : null) ?? updatable_releases.FirstOrDefault(x => x.ReleaseType == ReleaseType.Stable);
